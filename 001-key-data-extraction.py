...
class Person(BaseModel):
    ...
    lastname: Optional[str] = Field(
        default=None, description="The last name of the person"
    )
    country: Optional[str] = Field(
...
class User(BaseModel):
    ...
    name:Optional[str]= Field(
        default=None, description="The name of the user"
    )
    lastname:Optional[str] = Field(
        default=None, description="The last name of the user"
    )
    country:Optional[str] = Field(
        default=None, description="Country of the user"
    )

class Users(BaseModel):
    """Extracted data about the user"""
    users: List[User]
